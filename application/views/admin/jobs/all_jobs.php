                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        ...
                                        <?php if ($this->session->userdata('role') == 'admin'): ?>
                                            ...
                                            <a id="delete" data-toggle="modal" data-target="#confirm_delete_<?php echo $job['id'];?>" href="#"  data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-trash text-danger m-r-10"></i> </a>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php if(check_power(3)):?>
                                                <a href="<?php echo base_url('admin/jobs/delete/'.$job['id']) ?>" onClick="return doconfirm();" data-toggle="tooltip" data-original-title="Delete"> <i class="fa fa-trash text-danger m-r-10"></i> </a>
                                            <?php endif; ?>
